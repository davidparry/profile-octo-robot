...
/**
 * Data Transfer Object for Widget API responses.
 * Provides a factory method for converting Widget entities to DTOs.
 */
public class WidgetResponseDTO {
    ...
    public WidgetResponseDTO(Long id, Long profileId, String name, String description, 
                            Map<String, Object> configuration, LocalDateTime createdAt, 
    ...
    /**
     * Factory method to create WidgetResponseDTO from Widget entity.
     * Follows the factory pattern for clean object creation.
     */
    public static WidgetResponseDTO from(Widget widget) {
