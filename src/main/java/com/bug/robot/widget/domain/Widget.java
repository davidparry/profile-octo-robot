...
import com.bug.robot.widget.converter.JsonAttributeConverter;
...
/**
 * Widget entity representing a widget associated with a user profile.
 * Follows SOLID principles with single responsibility for widget data.
 */
@Entity
...
public class Widget {
    ...
    // Getters and setters following existing Profile entity pattern
